...
SSID::Application.routes.draw do
  ...
  get 'clusters/ids_and_group_ids_for_student_ids' => 'submission_clusters#ids_and_group_ids_for_student_ids',
  ...
  namespace :api do
    namespace :v1 do
      ...
      resources :assignments, only: [] do
        resources :submission_similarities, only: %i[index show] do
          member do
            get 'view_pdf'
          end
        end
