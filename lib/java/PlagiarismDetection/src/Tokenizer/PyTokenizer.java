...
public final class PyTokenizer extends Tokenizer {
	...
	private static PyTokenizer instance = new PyTokenizer();
	...
	private void insertPyKeywords() {
		...
		String[] py_ignorable_keys = { "private", "protected", "public", "const" };

		for (String s : py_keys) {
			keywords.add(s);
		}

		for (String s : py_ignorable_keys) {
