...
ActiveRecord::Schema.define(version: 20_230_916_144_010) do
  ...
  create_table 'courses', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[code academic_year semester], name: 'index_courses_on_code_and_academic_year_and_semester',
                                             unique: true
  end
  ...
  create_table 'submission_cluster_groups', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[assignment_id cut_off_criterion], name: 'on_assignment_id_and_cut_off_criterion', unique: true
    t.index ['assignment_id'], name: 'index_submission_cluster_groups_on_assignment_id'
  end

  create_table 'submission_cluster_memberships', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                                 force: :cascade do |t|
    t.integer 'submission_cluster_id', null: false
    t.integer 'submission_id', null: false
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[submission_cluster_id submission_id], name: 'members', unique: true
  end
  ...
  create_table 'submission_similarities', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[assignment_id similarity], name: 'on_assignment_id_and_similarity'
    t.index %w[assignment_id similarity_1_to_2 similarity_2_to_1],
            name: 'on_assignment_id_and_similarity_1_to_2_and_similarity_2_to_1'
    t.index %w[assignment_id similarity_1_to_2], name: 'on_assignment_id_and_similarity_1_to_2'
    t.index %w[assignment_id similarity_2_to_1], name: 'on_assignment_id_and_similarity_2_to_1'
    t.index %w[assignment_id status], name: 'index_submission_similarities_on_assignment_id_and_status'
    t.index %w[assignment_id submission1_id submission2_id],
            name: 'on_assignment_id_and_submission1_id_and_submission2_id'
    t.index ['assignment_id'], name: 'index_submission_similarities_on_assignment_id'
  end

  create_table 'submission_similarity_mappings', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                                 force: :cascade do |t|
    t.integer 'submission_similarity_id', null: false
  ...
  create_table 'submission_similarity_processes', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                                  force: :cascade do |t|
    t.integer 'assignment_id', null: false
    t.integer 'pid'
  ...
  create_table 'submission_similarity_skeleton_mappings', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3',
                                                          force: :cascade do |t|
  ...
  create_table 'submissions', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[student_id is_plagiarism], name: 'index_submissions_on_student_id_and_is_plagiarism'
  ...
  create_table 'user_course_memberships', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb3', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[user_id course_id], name: 'index_user_course_memberships_on_user_id_and_course_id', unique: true
  end
